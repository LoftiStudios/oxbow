...
`CLAUDE.md` says the task queue is the core abstraction and should be modelled
...
into a directory we consider abandoned (`docs/handoff.md` §3.4).
...
the CLI rather than just Oxbow (`docs/handoff.md` §8 — address ScrubN):
